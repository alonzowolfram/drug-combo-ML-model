...
def define_models(models=dict()):
	...
	#for c in c_values:
	#	models['SVR'+str(c)] = SVR(C=c, verbose = True) # Verbose. Bool. Takes forever unless you're scaling the variables.
...
Create a dict of standard models to evaluate {name:object}.
'''
def define_models_non_linear(models=dict()):
...
def main():
    ...
    # Get model list.
    models = define_models() # If doing the main models.
    #models = define_models_non_linear() # If doing the non-linear models. 
